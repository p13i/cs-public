...
using ::cs::www::app::protos::GetAnimationRequest;
using ::cs::www::app::protos::GetAnimationResponse;
using ::cs::www::app::protos::GetUuidRequest;
using ::cs::www::app::protos::GetUuidResponse;
using ::cs::www::app::text::fonts::SampleCharacterPixel;
}  // namespace
...
void LoginApi() {
  cs::www::app::protos::LoginRequest request;
  request.email = "pramod@p13i.io";
  request.password = "p13i";
  FETCH_API(
      POST, "/api/login/",
      cs::www::app::protos::LoginRequest,
      cs::www::app::protos::LoginResponse, request,
      [&](ResultOr<cs::www::app::protos::LoginResponse>
              result) {
        if (!result.ok()) {
          LOG(ERROR) << result << ENDL;
          return;
