...
unsigned char uch(char c) {
  return static_cast<unsigned char>(c);
}

char to_lower_uc(unsigned char c) {
...
bool istarts_with(std::string_view s, size_t pos,
                  std::string_view lit) {
...
std::string MinifyCSS(std::string_view css) {
...
std::string MinifyHTMLImpl(std::string_view in) {
